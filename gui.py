...
# Displaying a header
    ...
    # Load the dataset
    df = pd.read_csv(r"https://raw.githubusercontent.com/MohamedAlaa2005/jumia_analysis/refs/heads/data/scraping.csv")
    ...
    with tabs[0]:
        url = r"https://raw.githubusercontent.com/MohamedAlaa2005/jumia_analysis/refs/heads/data/Jumia%20Data%20Analysis%20Report.html"
        response = requests.get(url)
        source_code = response.text
        st.components.v1.html(source_code, height=11100)

    with tabs[1]:
        df = pd.read_csv(r"https://raw.githubusercontent.com/MohamedAlaa2005/jumia_analysis/refs/heads/data/Cleaned_Data.csv")
